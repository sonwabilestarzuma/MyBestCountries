...
using MyBestCountries.Services;
using MyBestCountries.ViewModel.Manage;
using MyBestCountries.Controllers;

namespace MyBestCountries.Web.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public IActionResult LinkLogin(string provider)
        {
            ...
            //var properties = _signInManager.ConfigureExternalAuthenticationProperties(provider, redirectUrl, User.GetUserId(User));
